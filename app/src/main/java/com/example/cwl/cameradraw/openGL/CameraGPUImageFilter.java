...
public class CameraGPUImageFilter extends GPUImageFilter {
    ...
    public void setmTextureTransformMatrix(float[] mtx){
    ...
    public void initCameraFrameBuffer(int width, int height){
        if(mFrameBuffers != null &&(mFrameHeight != height || mFrameWidth != width)){
            destoryFramebuffers();
        }
        if(mFrameBuffers == null){
            mFrameWidth = width;
    ...
    public void destoryFramebuffers(){
        if(mFrameBufferTextures != null){
            GLES20.glDeleteTextures(1, mFrameBufferTextures, 0);
            mFrameBufferTextures = null;
        }
        if(mFrameBuffers != null){
            GLES20.glDeleteTextures(1, mFrameBuffers, 0);
            mFrameBuffers = null;
        }
        mFrameWidth = -1;
        mFrameHeight = -1;
